...
//var objectPointingArrowOutOfTheVaultBodyToVault112 = document.getElementById("objectPointingArrowOutOfTheVaultBodyToVault112");
//var objectPointingArrowOutOfTheVaultBodyToDangerousWasteland = document.getElementById("objectPointingArrowOutOfTheVaultBodyToDangerousWasteland");
//var youFoundYourDadVault112Body = document.getElementById("youFoundYourDadVault112Body");
//var meetDeathClawYouFuckedUpBody = document.getElementById("meetDeathClawYouFuckedUpBody");
...
/*///---<<<begin new level (startMenu)>>>---///*/ /*///---<<<begin new level (startMenu)>>>---///*/
function startMenu() {
	"use strict";
	...
	hideOpacityDisplay(youFoundYourDadVault112Body);
	hideOpacityDisplay(meetDeathClawYouFuckedUpBody);
	...
	var imageCount = "1";
	var startMenuSlideShow = window.setInterval(function () {
	...
	document.getElementById("startGameButton").onclick = function () {
		startGameIntro();
		fallout3Theme.pause();
		clearInterval(startMenuSlideShow);
	};
}
...
function startGameIntro() {
	...
	setTimeout(function () {
		bosSoldierInFrontOfTheWasteland.style.opacity = (1);
	}, 500);
	setTimeout(function () {
		bosSoldierInFrontOfTheWasteland.style.opacity = (0);
		a();
	}, 3000);

	function a() {
		setTimeout(function () {
			bethesdaGameStudiosTitle.style.opacity = (1);
			b();
		}, 2000);
	}
	...
	function b() {
		setTimeout(function () {
			bethesdaGameStudiosTitleSpan.style.textDecoration = "line-through";
			c();
		}, 1500);
	}
	...
	function c() {
		setTimeout(function () {
			bethesdaGameStudiosTitleSpanElias.style.opacity = (1);
			e();
		}, 300);
	}
	...
	function e() {
		setTimeout(function () {
			bethesdaGameStudiosTitleSpanElias.style.transition = "0.8s linear";
		}, 1000);
		setTimeout(function () {
			fallout3AdventureGameContainer.style.opacity = (1);
		}, 1000);
		setTimeout(function () {
			fallout3AdventureGameTitleStartGameIntro.style.opacity = (1);
			f();
		}, 2000);
	}
	...
	function g() {
		setTimeout(function () {
			warWarNeverChanges.style.opacity = (1);
			h();
		}, 1500);
	}
	...
	function h() {
		setTimeout(function () {
			warWarNeverChanges.style.opacity = (0);
			i();
		}, 2000);
	}
	...
	function i() {
		setTimeout(function () {
			vaultTecLogoStartGameIntro.style.opacity = (1);
		}, 1500);
		setTimeout(function () {
			vaultTecLogoTitle.style.opacity = (1);
		}, 2500);
		setTimeout(function () {
			vaultTecLogoSlogan.style.opacity = (1);
			j();
		}, 3500);
	}
...
/*///---<<<begin new level (storyExplanation)>>>---///*/
/*///---<<<begin new level (storyExplanation)>>>---///*/ /*///---<<<begin new level (storyExplanation)>>>---///*/
...
/*///---<<<begin new level (justBorn)>>>---///*/
/*///---<<<begin new level (justBorn)>>>---///*/ /*///---<<<begin new level (justBorn)>>>---///*/
...
function justBorn() {
	...
	infoBoxTopLeftSpecific.innerHTML = "You are born, choose your gender and name";
	showOpacityDisplayF(justBornBody);
	showOpacityDisplayF(chooseGenderContainer);
	hideDisplay(chooseNameContainer);
	...
	submitChosenName.onclick = function () {
		...
		hideOpacity(infoBoxTopLeft);
		babySteps();
	};
}

/*///---<<<begin new level (babySteps)>>>---///*/
/*///---<<<begin new level (babySteps)>>>---///*/ /*///---<<<begin new level (babySteps)>>>---///*/
...
function babySteps() {
	...
	setTimeout(function () {
		...
		infoBoxTopLeftGeneral.innerHTML = "You can click on specific objects to activate them";
		infoBoxTopLeftSpecific.innerHTML = "Click on the door of the playpen to get out of it";
...
/*///---<<<begin new level (happy10thBirthday)>>>---///*/
/*///---<<<begin new level (happy10thBirthday)>>>---///*/ /*///---<<<begin new level (happy10thBirthday)>>>---///*/
...
/*///---<<<begin new level (yourDadEscaped)>>>---///*/ /*///---<<<begin new level (yourDadEscaped)>>>---///*/
...
function yourDadEscaped() {
		...
		document.getElementById("inventoryButton").onclick = function () {
			if (inventoryContainer.style.opacity === "1") {
				...
				for (var i = 0; i < inventory.length; i++) {
					...
					div.setAttribute("class", "itemsContainers");
					var img = document.createElement("img");
					img.src = "Graphics/Pick Up Items/" + itemName + ".png";
					var p = document.createElement("p");
					p.setAttribute("class", "p");
					p.innerHTML = itemName;
					div.appendChild(img);
	...
	objectPointingArrowYourDadEscapedToBBGun.onclick = function () {
		lookingAtBBGun();
	};
	objectPointingArrowYourDadEscapedToBaseBallBat.onclick = function () {
		lookingAtBaseBallBat();
	};
...
function finishedDialogueWithAmata() {
	...
	changeBI(yourDadEscapedBody, "url('Graphics/Background Images/finishedDialogueWithAmata.png')");
	...
	objectPointingArrowYourDadEscapedGoBackToSleep.onclick = function () {
		...
		hideOpacityDisplay(objectPointingArrowYourDadEscapedOutOfTheRoom);
...
function lookingAtBBGun() {
	...
	changeBI(yourDadEscapedBody, "url('Graphics/Background Images/lookingAtBBGun.png')");
	...
	pickUpItemYourDadEscapedBBGun.onclick = function () {
		addItemToInventory(this);
	};
	objectPointingArrowGoBack.onclick = function () {
		finishedDialogueWithAmata();
	};
	setTimeout(function () {
		showOpacityDisplay(objectPointingArrowGoBack);
		//showOpacityDisplay(pickUpItemYourDadEscapedBBGun);
...
function lookingAtBaseBallBat() {
	...
	changeBI(yourDadEscapedBody, "url('Graphics/Background Images/lookingAtBaseBallBat.png')");
	showOpacityDisplay(pickUpItemYourDadEscapedBaseBallBat);
	showOpacityDisplay(objectPointingArrowGoBack);
	hideOpacityDisplay(objectPointingArrowYourDadEscapedToBBGun);
	hideOpacityDisplay(objectPointingArrowYourDadEscapedToBaseBallBat);
	hideOpacityDisplay(objectPointingArrowYourDadEscapedGoBackToSleep);
	pickUpItemYourDadEscapedBaseBallBat.onclick = function () {
		addItemToInventory(this);
	};
	objectPointingArrowGoBack.onclick = function () {
		finishedDialogueWithAmata();
...
function escapeTheVault() {
	...
	talkerTextCount = 0;
	setTimeout(function () {
		changeBI(escapeTheVaultBody, "url('Graphics/Background Images/inOverseerOffice.png')");
	...
	function underTheOverseerOffice() {
		...
		changeBI(escapeTheVaultBody, "url('Graphics/Background Images/underTheOverseerOffice.png')");
	...
	function vaultExitRoom() {
		...
		changeBI(escapeTheVaultBody, "url('Graphics/Background Images/vaultExitRoom.png')");
	...
	function vaultDoorInFrontOfControlPanel() {
		...
		hideOpacityDisplay(infoBoxTopLeft);
		changeBI(escapeTheVaultBody, "url('Graphics/Background Images/vaultExitControlPanel.png')");
	...
	function vaultExitTunnel() {
		...
		changeBI(escapeTheVaultBody, "url('Graphics/Background Images/vaultExitTunnel.png')");
		...
		objectPointingArrowEscapeTheVaultInVaultExitTunnelToOutside.onclick = function () {
			...
			changeBI(body, "url('Graphics/Background Images/white.jpg')");
			outOfTheVault();
		};
	}
}
...
/*///---<<<begin new level (outOfTheVault)>>>---///*/ /*///---<<<begin new level (outOfTheVault)>>>---///*/
function outOfTheVault() {
	...
	changeBI(outOfTheVaultBody, "url('Graphics/Background Images/white.jpg')");
	showOpacity(infoBoxTopLeft);
	setTimeout(function () {
		changeBI(outOfTheVaultBody, "url('Graphics/Background Images/outOfTheVault.png')");
...
/*///---<<<begin new level (youFoundYourDadVault112)>>>---///*/ /*///---<<<begin new level (youFoundYourDadVault112)>>>---///*/
function youFoundYourDadVault112() {
	...
	setTimeout(function () {
		changeBI(youFoundYourDadVault112Body, "url('Graphics/Background Images/youFoundYourDadVault112.png')");
		showOpacity(inventoryButton);
		showOpacityDisplay(infoBoxTopLeft);
...
/*///---<<<begin new level (meetDeathClawYouFuckedUp)>>>---///*/ /*///---<<<begin new level (meetDeathClawYouFuckedUp)>>>---///*/
function meetDeathClawYouFuckedUp() {
	...
	setTimeout(function () {
		changeBI(meetDeathClawYouFuckedUpBody, "url('Graphics/Background Images/meetDeathClawYouFuckedUp.png')");
		showOpacity(inventoryButton);
		showOpacityDisplay(infoBoxTopLeft);
